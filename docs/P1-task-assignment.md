...
| P1 | 2天 | P2-1 多租户后端（users/invite_codes/store_auths表 + auth API） | ✅ 完成 |
...
| 任务等级 | 失时效 | 任务 | 状态 |
|---|---|---|---|
| P1 | 2天 | P1-1 ai.py 5个端点（analyze/keywords/generate_images/translate/chat_assistant） | ✅ Accio完成，OpenCLAW验证 |
| P1 | 2天 | P1-2 customer_service.py 2个端点（list/suggest） | ✅ OpenCLAW完成并推送 |
| P1 | 2天 | P2-9~12 官网/公众号同步 + 数据看板 | 待开始 |
| P1 | 2天 | ProductMaintainView 数据接口 | 待开始 |
| P1 | 2天 | ProductCollectView 后端爬虫 | 待开始 |
...
| P1 | 2天 | LoginView 接 auth.py | 待开始 |
| P1 | 2天 | ActivityCenterView CMS接入 | 待开始 |
...
- API 服务：localhost:8506 dev / 47.76.179.242:8506 prod
